...
character monogram, or an image, with an optional color. On mobile, expand the machine under
**Settings → Environments** and tap **Icon** to choose a named icon or a photo.
