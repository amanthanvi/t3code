 ...
 */
export const ENVIRONMENT_LUCIDE_ICON_IDS = [
  "activity",
  "anchor",
  "antenna",
  "beaker",
...
export const EnvironmentLucideIconId = Schema.Literals(ENVIRONMENT_LUCIDE_ICON_IDS);
export type EnvironmentLucideIconId = typeof EnvironmentLucideIconId.Type;
export const isEnvironmentLucideIconId = Schema.is(EnvironmentLucideIconId);
