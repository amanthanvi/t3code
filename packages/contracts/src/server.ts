...
export const ServerProvider = Schema.Struct({
  ...
  // Optional for backward compatibility. An absent list means every runtime
  // mode is supported; providers with stricter boundaries advertise them.
  supportedRuntimeModes: Schema.optional(Schema.Array(RuntimeMode)),
  // Optional for backward compatibility. An absent value keeps the legacy
  // behavior where clients allow image attachments.
