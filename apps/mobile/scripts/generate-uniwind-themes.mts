...
const ADAPTIVE_COLORS: Readonly<Record<string, readonly [light: string, dark: string]>> = {
  ...
  "--color-adaptive-cyan-600-400": [color("cyan", 600), color("cyan", 400)],
  ...
  "--color-adaptive-fuchsia-600-400": [color("fuchsia", 600), color("fuchsia", 400)],
  "--color-adaptive-gray-600-400": [color("gray", 600), color("gray", 400)],
  "--color-adaptive-green-600-400": [color("green", 600), color("green", 400)],
  ...
  "--color-adaptive-indigo-600-400": [color("indigo", 600), color("indigo", 400)],
  "--color-adaptive-indigo-700-300": [color("indigo", 700), color("indigo", 300)],
  "--color-adaptive-lime-600-400": [color("lime", 600), color("lime", 400)],
  ...
  "--color-adaptive-orange-600-400": [color("orange", 600), color("orange", 400)],
  "--color-adaptive-pink-600-400": [color("pink", 600), color("pink", 400)],
  "--color-adaptive-purple-600-400": [color("purple", 600), color("purple", 400)],
  ...
  "--color-adaptive-teal-600-400": [color("teal", 600), color("teal", 400)],
  ...
  "--color-adaptive-yellow-600-400": [color("yellow", 600), color("yellow", 400)],
